    ...
    return(
        <div className='dark:bg-indigo-400 bg-slate-300 w-56 h-40 rounded-xl p-2 pl-4 flex flex-col justify-between'>
            ...
            <div className='flex flex-col justify-around h-3/4'>
                ...
                <p className=' w-5 h-5 rounded-full p-4 flex justify-center items-center bg-orange-400 '><FontAwesomeIcon icon={faArrowUp} className='text-black/40'/></p>
                <p>{new Date(Number(props.sunrise)+Number(props.timezone)*60000).toString().slice(15,21)}</p>
                </div>
                <div className='flex gap-3'>
                <p className='w-5 h-5 rounded-full p-4 flex justify-center items-center bg-orange-400'><FontAwesomeIcon icon={faArrowUp} className='rotate-180 text-black/40'/></p>
